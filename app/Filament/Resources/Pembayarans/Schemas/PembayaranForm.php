...
class PembayaranForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Data Pembayaran')->schema([
                Grid::make(2)->schema([
                    Select::make('tagihan_siswa_id')
                        ...
                        ->getOptionLabelFromRecordUsing(
                            fn (
                                TagihanSiswa $record,
                            ) => "{$record->nomor_tagihan} - {$record->siswa->nama} (Sisa: Rp ".
                                number_format(
                                    $record->sisa_tagihan,
                                    0,
                                    ',',
                ...
                Placeholder::make('tagihan_info')
                    ...
                    ->content(function ($get) {
                        ...
                        return "Siswa: {$tagihan->siswa->nama} | Jenis: {$tagihan->jenisPembayaran->nama} | Total: Rp ".
                            number_format(
