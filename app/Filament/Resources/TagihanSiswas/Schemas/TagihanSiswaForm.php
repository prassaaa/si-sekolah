...
class TagihanSiswaForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Data Tagihan')->schema([
                Grid::make(2)->schema([
                    ...
                    Select::make('jenis_pembayaran_id')
                        ...
                        ->afterStateUpdated(function (
                            ...
                            if ($state) {
                                $jenisPembayaran = JenisPembayaran::find(
                                    $state,
                                );
                                if ($jenisPembayaran) {
                                    ...
                                    $set(
                                        'tanggal_jatuh_tempo',
                                        $jenisPembayaran->tanggal_jatuh_tempo,
                                    );
                                }
                            }
                        })
                ...
                Grid::make(2)->schema([
                    Select::make('semester_id')
                        ...
                        ->getOptionLabelFromRecordUsing(
                            fn (
                                Semester $record,
                            ) => "{$record->tahunAjaran->nama} - {$record->nama}",
                        ),
            ...
            Section::make('Nominal Tagihan')->schema([
                Grid::make(3)->schema([
