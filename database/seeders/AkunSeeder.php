...
class AkunSeeder extends Seeder
{
    public function run(): void
    {
        $akuns = [
            ...
            ['kode' => '1-1005', 'nama' => 'Kas Kecil', 'tipe' => 'aset', 'kategori' => 'lancar', 'parent_id' => null, 'level' => 1, 'posisi_normal' => 'debit', 'deskripsi' => 'Kas kecil (petty cash) untuk pengeluaran operasional harian', 'saldo_awal' => 0, 'saldo_akhir' => 0, 'is_active' => true],
